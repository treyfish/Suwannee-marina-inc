  ...
  return (
    <>
      ...
      <section className="py-20 px-4 bg-cream">
        <div className="max-w-5xl mx-auto">
          <ScrollReveal className="mb-10">
            <div className="bg-teal/5 rounded-xl p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 border border-teal/10">
              ...
              <div>
                <p className="text-dark font-semibold">NOAA Station 8727520</p>
                <p className="text-driftwood text-sm">
                  Suwannee River Entrance, Dixie County, FL. Datum: MLLW (Mean Lower Low Water).
                  All times in local time. Data is for planning purposes — always exercise caution on the water.
                </p>
              </div>
            </div>
          </ScrollReveal>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <ScrollReveal>
            <h2 className="text-2xl font-bold text-dark mb-6">Tide Tips for the Suwannee</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div key={tip.title} className="bg-cream rounded-xl p-6">
                  <h3 className="font-semibold text-dark mb-2">{tip.title}</h3>
                  <p className="text-driftwood text-sm leading-relaxed">{tip.desc}</p>
                </div>
              ))}
            </div>
          </ScrollReveal>
